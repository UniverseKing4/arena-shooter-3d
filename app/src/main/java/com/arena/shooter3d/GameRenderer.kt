...
class GameRenderer(
    ...
    private fun drawSun() {
        ...
        val pulse = 1f + sin((System.currentTimeMillis() % 3000).toFloat() / 3000f * 6.28f) * 0.03f
        Matrix.scaleM(model, 0, 2.5f * pulse, 2.5f * pulse, 2.5f * pulse)
        setMats()
        GLES20.glUniform3f(uColor, 1f, 0.9f, 0.6f)
